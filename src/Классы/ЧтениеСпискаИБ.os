...
Функция ДобавитьЗапись(Элемент)
	...
	Запись.Вставить("КаталогЖР"        ,
	                СтрШаблон("%1\reg_%2\%3\1Cv8Log", Запись.Кластер_Каталог, Запись.Кластер_Порт, Запись.Ид));
	Запись.Вставить("СловарьЖР"        ,
	                СтрШаблон("%1\reg_%2\%3\1Cv8Log\1cv8.lgf", Запись.Кластер_Каталог, Запись.Кластер_Порт, Запись.Ид));

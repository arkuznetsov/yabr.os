...
Функция ДобавитьЗапись(Элемент)
	...
	ОписаниеМодуля = Контейнер[ИндексНач];

	Запись = Новый Структура();
	Запись.Вставить("МодульИд"            , ОбработатьКавычкиВСтроке(ОписаниеМодуля.Значения[1]));
	Запись.Вставить("ВидМодуляИд"         , ОбработатьКавычкиВСтроке(ОписаниеМодуля.Значения[2]));
	Запись.Вставить("ТипКонтейнераИд"     , ОбработатьКавычкиВСтроке(ОписаниеМодуля.Значения[5]));
	Запись.Вставить("ИмяРасширения"       , ОбработатьКавычкиВСтроке(ОписаниеМодуля.Значения[7]));
	Запись.Вставить("ИмяВнешнегоМодуля"   , ОбработатьКавычкиВСтроке(ОписаниеМодуля.Значения[0].Значения[0]));
